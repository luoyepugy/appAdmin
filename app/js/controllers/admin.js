  	...
  	function adminCtrl($state) {
        ...
        vm.menuList = [
            {'menuTitle': '会员管理', 'isOpen': true, 'childMenuList': [
                {'childMenuTitle': '会员列表', 'state': 'admin.vip-list', 'isActive': true, 'menuIndex': 0}
                ]
            },
            {'menuTitle': '订单管理', 'isOpen': false, 'childMenuList': [
                {'childMenuTitle': '订单列表', 'state': 'admin.order-list', 'isActive': false, 'menuIndex': 1},
                ]
            },
            {'menuTitle': '权限管理', 'isOpen': false, 'childMenuList': [
                {'childMenuTitle': '管理员列表', 'state': 'admin.auth-list', 'isActive': false, 'menuIndex': 2},
                {'childMenuTitle': '角色列表', 'state': 'admin.auth-role', 'isActive': false, 'menuIndex': 2}
                ]
            },
        ];
