...
angular.module('app')
  .controller('authRoleEditCtrl', authRoleEditCtrl);
    ...
    function authRoleEditCtrl(httpService, $stateParams, messageService) {
        ...
        // 列出菜单列表
        vm.menuList = [
            {'name': '会员管理 / 采购商列表', 'id': 11},
            {'name': '会员管理 / 供应商列表', 'id': 12},
            {'name': '订单管理 / 报价列表', 'id': 21},
            {'name': '订单管理 / 待支付列表', 'id': 22},
            {'name': '订单管理 / 已支付列表', 'id': 23},
            {'name': '订单管理 / 已发货列表', 'id': 24},
            {'name': '订单管理 / 已完成列表', 'id': 25},
            {'name': '订单管理 / 已关闭列表', 'id': 26},
